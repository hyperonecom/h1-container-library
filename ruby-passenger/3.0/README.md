...
```h1cr.io/website/ruby-passenger:3.0```
...
Środowisko udostępnia najnowszą stabilną wersji Ruby 3.0. W środowisku mogą zostać wprowadzone nowe drobne poprawki, ale nie ulega zmianie główna wersja.

Na przykład środowisko może zawierać Ruby 3.0.1, a później zostać zaktualizowane do Ruby 3.0.15, ale nie będzie automatycznie aktualizowane do wyższego wydania rzędu wskazanego w nazwie obrazu.
