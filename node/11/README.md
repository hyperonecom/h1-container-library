...
Interpreter NodeJS jest odpowiedzialny za obsługę przychodzącego żądania i udzielenia  w celu udzielenia odpowiedzi dynamicznej odpowiedzi wygenerowanej z pomocą język 1111.

Środowisko udostępnia najnowszą stabilną wersji NodeJS 11. W środowisku mogą zostać wprowadzone nowe drobne poprawki, ale nie ulega zmianie główna wersja.

Na przykład środowisko może zawierać NodeJS 11.1.1, a później zostać zaktualizowane do NodeJS 11.2.15, ale nie będzie automatycznie aktualizowana do wyższego wydania głównego.
