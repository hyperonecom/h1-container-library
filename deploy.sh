...
docker tag h1cr.io/website/node:12 h1cr.io/website/node:latest
docker push h1cr.io/website/node:latest
...
docker tag h1cr.io/website/php-apache:7.4 h1cr.io/website/php-apache:latest
docker push h1cr.io/website/php-apache:latest
...
docker tag h1cr.io/website/php-apache-shell:7.4 h1cr.io/website/php-apache-shell:latest
docker push h1cr.io/website/php-apache-shell:latest
docker push h1cr.io/website/python-passenger:3.7
docker push h1cr.io/website/python-passenger:3.8
docker tag h1cr.io/website/python-passenger:3.8 h1cr.io/website/python-passenger:latest
docker push h1cr.io/website/python-passenger:latest