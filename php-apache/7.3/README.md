...
Na przykład środowisko może zawierać PHP 7.3.12, a później zostać zaktualizowane do PHP 7.3.15, ale nie będzie automatycznie aktualizowana do wyższego wydania głownego.
