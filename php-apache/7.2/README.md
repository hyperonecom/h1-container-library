...
Na przykład środowisko może zawierać PHP 7.2.12, a później zostać zaktualizowane do PHP 7.2.15, ale nie będzie automatycznie aktualizowana do wyższego wydania głownego.
